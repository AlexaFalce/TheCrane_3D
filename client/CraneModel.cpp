...
{
	PerspectiveCamera* staticCamera1 = new PerspectiveCamera("Front camera", CameraType::STATIC, glm::vec3(0.0f, 19.0f, 100.0f), glm::vec3(0.0f, 21.0f, 55.0f), 45.0f, 0.0f, 1.0f, 150.0f);
	if (staticCamera1->getIsAvailable())
		cameras.push_back(staticCamera1);

	PerspectiveCamera* dynamicCamera1 = new PerspectiveCamera("Observer camera", CameraType::DYNAMIC, glm::vec3(10.5f, 2.5f, 42.5f), glm::vec3(10.5f, 4.5f, -2.5f), 40.0f, 0.0f, 1.0f, 100.0f);
	if (dynamicCamera1->getIsAvailable())
		cameras.push_back(dynamicCamera1);
	

	PerspectiveCamera* cabinCamera1 = new PerspectiveCamera("Cabin camera", CameraType::CABIN, glm::vec3(6.7f, 42.9f, 1.7f), glm::vec3(-19.034f, 40.177f, 0.009f), 45.0f, 0.0f, 1.0f, 100.0f);
	if (cabinCamera1->getIsAvailable())
		cameras.push_back(cabinCamera1);

	PerspectiveCamera* cabinCamera2 = new PerspectiveCamera("Cabin camera", CameraType::CABIN, glm::vec3(6.7f, 42.9f, 1.7f), glm::vec3(-38.5f, 32.0f, 1.0f), 45.0f, 0.0f, 1.0f, 100.0f);
