...
Node* FileReader::recursiveLoading()
{
    ...
    switch ((OvObject::Type)chunkId)
    {
        ...
        case OvObject::Type::SKINNED:
        {
            ...
            vector<vector<Vertex*>> LODVectorVertex; // save all levels of details available
            vector<Vertex*> vertexList; 
            std::map<unsigned int, Vertex*> allVertex; // key = level | value = vertex
            ...
            vector<Vertex*> firstLODVertex = LODVectorVertex[0]; // first level of details
